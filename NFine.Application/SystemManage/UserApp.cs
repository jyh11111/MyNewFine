...
namespace NFine.Application.SystemManage
{
    public class UserApp
    {
        ...
        {
            return service.IQueryable().OrderBy(t => t.F_OrganizeId).ToList();
        }
        ...
        public UserEntity CheckLogin(string username, string password)
        {
            ...
            if (userEntity == null)
            {
                if (!username.Contains("@"))
                    userEntity = service.FindEntity(t => t.F_MobilePhone == username);
                else
                    userEntity = service.FindEntity(t => t.F_Email == username);
            }
            if (userEntity != null)
            {
