...
namespace NFine.Data
{
    ...
    public class RepositoryBase<TEntity> : IRepositoryBase<TEntity> where TEntity : class,new()
    {
        ...
        public int ExecuteSql(string sqlStr,params object[] paramters)
        {
            return dbcontext.Database.ExecuteSqlCommand(sqlStr, paramters);
        }
        public List<TEntity2> FindList2<TEntity2>(string strSql)
        {
            return dbcontext.Database.SqlQuery<TEntity2>(strSql).ToList<TEntity2>();
        }
        public List<TEntity2> FindList2<TEntity2>(string strSql, DbParameter[] dbParameter)
        {
            return dbcontext.Database.SqlQuery<TEntity2>(strSql, dbParameter).ToList<TEntity2>();
        }
    }
}
