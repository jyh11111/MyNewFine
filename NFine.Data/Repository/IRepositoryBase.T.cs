...
namespace NFine.Data
{
    ...
    public interface IRepositoryBase<TEntity> where TEntity : class,new()
    {
        ...
        int ExecuteSql(string sqlStr, params object[] paramters);

        List<TEntity2> FindList2<TEntity2>(string strSql);

        List<TEntity2> FindList2<TEntity2>(string strSql, DbParameter[] dbParameter);
    }
}
