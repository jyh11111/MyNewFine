...
namespace NFine.Web.Controllers
{
    ...
    public class ClientsDataController : Controller
    {
        ...
        private object GetUserList()
        {
            ...
            foreach (var item in data)
            {
                var fieldItem = new
                {
                    ...
                    mobilephone=item.F_MobilePhone,
                    email = item.F_Email,
        ...
        private object GetLegoPartList()
        {
            LegoPartApp partApp = new LegoPartApp();
            Dictionary<string, object> dictionary = new Dictionary<string, object>();
        ...
        private object GetPostionList()
        {
            PositionApp postionApp = new PositionApp();
            Dictionary<string,object> dictionary=new Dictionary<string,object>();
            var data=postionApp.GetList();
            foreach (var item in data)
            {
                var fieldItem = new
                {
                    positionid = item.F_Id,
